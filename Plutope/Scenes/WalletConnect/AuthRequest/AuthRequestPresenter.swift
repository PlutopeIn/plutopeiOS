...
final class AuthRequestPresenter: ObservableObject {
    ...
    private func createAuthObjectForChain(chain: Blockchain) throws -> AuthObject {
        ...
        let supportedAuthPayload = try WalletKit.instance.buildAuthPayload(payload: request.payload, supportedEVMChains: [Blockchain("eip155:1")!, Blockchain("eip155:137")!, Blockchain("eip155:56")!, Blockchain("eip155:66")!, Blockchain("eip155:97")!, Blockchain("eip155:10")!, Blockchain("eip155:42161")!, Blockchain("eip155:43114")!, Blockchain("eip155:8453")!], supportedMethods: ["personal_sign", "eth_sendTransaction"])
    ...
    func getCommonAndRequestedChainsIntersection() -> Set<Blockchain> {
        ...
        let supportedChains: Set<Blockchain> = [Blockchain("eip155:1")!, Blockchain("eip155:137")!, Blockchain("eip155:56")!, Blockchain("eip155:66")!, Blockchain("eip155:97")!, Blockchain("eip155:10")!, Blockchain("eip155:42161")!, Blockchain("eip155:43114")!, Blockchain("eip155:8453")!]
