...
//  Plutope
//
//  Created by Trupti Mistry on 09/07/24.
//
...
class PendingViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        print("cardNumber =",cardNumber)
            ...
            lblTitle.text = LocalizationSystem.sharedInstance.localizedStringForKey(key: LocalizationLanguageStrings.pendingMsg, comment: "")//"Your transaction is pending. Please verify with email."
