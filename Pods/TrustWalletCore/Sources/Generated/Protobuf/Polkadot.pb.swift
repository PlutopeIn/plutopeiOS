...
extension TW_Polkadot_Proto_SigningInput: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 9: try { try decoder.decodeSingularUInt32Field(value: &self.network) }()
      case 10: try {
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.network != 0 {
      try visitor.visitSingularUInt32Field(value: self.network, fieldNumber: 9)
    }
    switch self.messageOneof {
